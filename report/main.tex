...
\begin{itemize}
    ...
    \item A \textbf{word embedding}\cite{wordembeddings} approach with the FastText\cite{fasttext} library to retrieve the morphological relationships between the words in a sentence.
\end{itemize}
\begin{figure}[h]
        \centering
...
- Model introduction
- Results of the different techniques w/ table
- Feature importances
